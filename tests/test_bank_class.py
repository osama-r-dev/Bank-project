...
class TestBank(unittest.TestCase):
    def setUp(self):  
     ...
     self.bank1.addCustomer("osama","alrehaili","3434343$r43",1000,2000)
    
     self.bank2 = Bank()
     self.bank2.loadData()
     self.sami = self.bank2.addCustomer("Sami","alrehaili","123t$45678",1000,4000)
     self.ahmad = self.bank2.addCustomer("ahmad","khaled","11111114$e111",1000,6000)

    def test_add_customer(self):
      lastCustomer = self.bank1.customers[len(self.bank1.customers)-1]
      self.assertEqual(lastCustomer.account.id ,1)
      self.assertEqual(lastCustomer.firstName ,"osama")
      self.assertEqual(lastCustomer.lastName ,"alrehaili")
      self.assertEqual(lastCustomer.account.password ,"3434343$r43")
    ...
    def test_transfer_to_another_customer(self):
         ...
         self.bank2.transferToAnotherCustomer("osama",ahmadAccoount,"saving",1000,"1")
